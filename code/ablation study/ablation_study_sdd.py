...
def run_ablation_study(X_train, y_train, X_test, y_test, X_new, y_new, best_hp, features):
    ...
    base_weights = {
        ...
        'w2': best_hp.get('w2'),  # empirical bio-optical
    ...
    for config_name, weights in configurations:
        ...
        model_save_path = os.path.join(MODEL_SAVE_DIR, f"sdd_model_{config_name.lower()}.h5")

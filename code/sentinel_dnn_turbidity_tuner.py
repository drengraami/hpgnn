...
tuner = run_tuner(X_train, y_train['Turbidity'], X_test, y_test['Turbidity'],
                  directory='F:/Paper/Eco_Inf/tuner/dnn', project_name='Turbidity_sentinel_optimization', seed=42)
...
save_model(best_model, "F:/Paper/Eco_Inf/models/Turbidity_DNN_Model.h5")

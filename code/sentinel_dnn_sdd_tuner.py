...
tuner = run_tuner(X_train, y_train['Secchi_depth'], X_test, y_test['Secchi_depth'],
                  directory='F:/Paper/Eco_Inf/tuner/dnn', project_name='Secchi_depth_sentinel_optimization', seed=42)
...
save_model(best_model, "F:/Paper/Eco_Inf/models/Secchi_depth_DNN_Model.h5")
